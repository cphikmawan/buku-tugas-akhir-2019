...
\contentsline {lstlisting}{\numberline {IV.2}Konfigurasi docker-compose.yml}{27}{lstlisting.4.2}
...
\contentsline {lstlisting}{\numberline {IV.5}Perintah untuk inisiasi manager node}{28}{lstlisting.4.5}
...
\contentsline {lstlisting}{\numberline {IV.8}Perintah untuk mengunduh Docker Image}{29}{lstlisting.4.8}
