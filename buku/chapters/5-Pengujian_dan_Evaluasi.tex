	...
	\section{Hasil Uji Coba dan Evaluasi}
		...
		\subsection{Uji Performa}
			...
			\subsubsection{Uji Pembuatan \textit{Load Generator}}
				...
				Hasil dari pengujian sistem untuk pembuatan \textit{load generator} ditunjukkan pada Tabel \ref{suberdayasetpembuatan}.
				\begin{longtable}{|p{0.05\textwidth}|p{0.25\textwidth}|p{0.14\textwidth}|p{0.17\textwidth}|p{0.14\textwidth}|}
			...
			\subsubsection{Uji Performa Sistem Terhadap Request Jumlah \textit{Load Generator}}
				...
				Hasil dari pengujian performa sistem untuk pembuatan \textit{load generator} ditunjukkan pada Tabel \ref{sdhasilperforma}.
				\begin{longtable}{|p{0.05\textwidth}|p{0.20\textwidth}|p{0.12\textwidth}|p{0.10\textwidth}|p{0.15\textwidth}|p{0.12\textwidth}|}
